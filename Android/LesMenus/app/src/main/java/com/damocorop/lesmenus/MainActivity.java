...
//                new TimePickerDialog(this,new TimePickerDialog().ontime
                ...
                // thread en java
                // nidew thread(new Runnable(){@overre run() .... Thread.sleep(2000) }
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                Log.d("NOSLOGS","BOUTON DIALOG OK");
                            }
                        }) // rien de particulier sur l'evenement si on met null
                        .setNegativeButton("PAS OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int which) {
                                Log.d("NOSLOGS","BOUTON DIALOG PAS OK");
                            }})
                        .setCancelable(true) // tant qu'on clic pas sur OK, le menu disparait pas
                        .create()
                        .show();
